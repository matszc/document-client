...
import {SingleDocHomeComponent} from './single-doc.component';
...
describe('SingleDocHomeComponent', () => {
    let component: SingleDocHomeComponent;
    let fixture: ComponentFixture<SingleDocHomeComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(SingleDocHomeComponent);
